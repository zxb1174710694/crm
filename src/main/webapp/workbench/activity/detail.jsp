...
<script type="text/javascript">
        ...
        $("#savaRemarkBtn").click(function () {
            $.ajax({
                ...
                success:function (data) {
                    ...
                    //后端需要传来success，ActivityRemark对象
                    if (data.success){
                        var html = "";
                        ...
                        html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;">'+(data.activityRemark.createTime) +'由'+(data.activityRemark.createBy)+'</small>'
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">'
                        html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>'
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;'
                        html += '<a class="myHref" onclick="deleteRemark(\''+data.activityRemark.id+'\')" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>'
                        html += '</div>'
                        html += '</div>'
                        html += '</div>'

                        //$("#remarkDiv").before(html);
                        $("#savaRemark").html(html);
                    }
                }
            })
        })
	...
	function PageList() {
		...
		$.ajax({
			url:"workbench/activity/getMessage.do",
			data:{
				"id" : "${a.id}"
			},
			type:"get",
